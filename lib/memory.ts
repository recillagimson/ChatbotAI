...
export function buildSummaryPrompt(
  ...
  const system =
    ...
    `open questions or next steps. Be factual and concise — at most ${SUMMARY_MAX_WORDS} ` +
    `words, plain prose (no headers). Never invent anything not present in the text.`;
